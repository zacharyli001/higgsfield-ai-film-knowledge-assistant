...
xcrun clang -O2 -fobjc-arc -fblocks -framework Foundation -framework Speech "$ROOT/native/AppleSpeechHost.m" -o "$APP/Contents/MacOS/AppleSpeechHost"
...
JSON
echo "安装完成。请重新加载 3.9.0 扩展，然后在设置页点击‘检测 Apple 本地识别’。"
read -k 1 "?按任意键关闭…"
